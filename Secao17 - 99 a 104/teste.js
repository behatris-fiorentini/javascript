(function() {
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, "Capixaba"));
    ...
    */
    ...
    regular que irá fazer o match com as datas. 
    Crie grupos de captura para o
    ...
    */
    ...
    var regexDate = /(\d\d)(junho)(1804)/;
    console.log(text.replace(regexDate, "$1/$2/$3"));
