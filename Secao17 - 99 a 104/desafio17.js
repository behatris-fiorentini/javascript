(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Behatris Fiorentini'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'capixaba'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(valor) {
    ...
    */
    ...
    console.log('Removendo máscara do CPF 123.456.789-99:');
    console.log('123.456.789-99'.replace(/[\.\-]/g, ''));

    console.log('Colocando máscara no CPF 12345678999:');
    console.log('12345678999'.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, "$1.$2.$3-$4"));
