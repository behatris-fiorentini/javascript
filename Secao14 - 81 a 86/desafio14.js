(function() {
    ...
    */
    ...
    console.log(numberObjects.indexOf({
        number: 2
    }) > (-1) ? "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects :(");

    //A resposta é -1 porque, quando se cria um objeto, ele cria uma referencia única na memória, nenhum objeto é igual ao outro,
    // por isso ele não é igual ao { number: 2 } de dentro do array, porque ele é um novo objeto, que não apontam para a mesma referência
    ...
    */
    ...
    //Não, o resultado é o mesmo, pois os objetos não apontam para a mesma referência;
