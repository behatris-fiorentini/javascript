...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Behatris Fiorentini!

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostraIdade(); // Olá! Eu tenho 24 anos!
...
pessoa.apresentacao = function() {
    ...
    return "Olá, eu sou " + artigo + " " + pessoa.nome + " " + pessoa.sobrenome + ", tenho " + pessoa.idade + " " + ano + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu caminhei " + pessoa.caminhouQuantosMetros + " " + metro + "!";
}
