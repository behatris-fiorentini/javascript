(function() {
    ...
    */
    ...
    var cpfs = ["049-214 3421-1", "101.123-131x32", "210.458.522-05", "735 500 794 - 22"];

    var arrMask = [];
    cpfs.forEach(element => {
        arrMask.push(cleanCPF(element));
    });
    ...
    */
    ...
    console.log(tags.match(regexHtml));
    ...
    */
    ...
    // var regexHtml2 = /<\/?\w+>/g;
    var regexHtml3 = /<\w+><\/\w+>/g;

    var tags2 = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";

    console.log(tags2.match(regexHtml3));
    ...
    */
    ...
    var trocaFrase = texto.replace(newRegex, '$1 O texto dentro da tag "$1" é "$2" $3\n');
