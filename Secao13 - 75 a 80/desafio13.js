(function() {
    ...
    */
    ...
    var sudeste = ['Espírito Santo', 'São Paulo', 'Minas Gerais', 'Rio de Janeiro'];
    ...
    */
    ...
    brasil.unshift('Amazônia', 'Acre', 'Amapá');
    console.log(brasil);
    ...
    */
    ...
    console.log(busca ? "Ceará está incluído!" : "Ceará não foi incluído :(");
